...
<input type=\"hidden\" name=\"mos_per_sing\" value=\"".htmlspecialchars(fixset($mos_per_sing))."\">
<input type=\"hidden\" name=\"form_tabella\" value=\"".htmlspecialchars(fixset($form_tabella))."\">

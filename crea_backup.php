...
<input type=\"hidden\" name=\"mantieni_anni\" value=\"".htmlspecialchars(fixset($mantieni_anni))."\">
...
if (isset($nomi_contratti[$num1]) and strcmp($nomi_contratti[$num1],"")) echo " (".$nomi_contratti[$num1].")";
echo "</option>";
} # fine for $num1
echo "</select>";

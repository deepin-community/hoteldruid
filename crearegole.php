...
$origine = htmlspecialchars(fixset($origine));
if ($origine == "tab_reg1") {
...
$inizio_select = "";
$fine_select = "";
$motivazione_orig = htmlspecialchars(fixset($motivazione));
...
if (isset($motivazione2) and $motivazione2 == "x") { $sel_x = " selected"; $sel = ""; }
...
if (!isset($app_agenzia) or !strcmp($app_agenzia,"")) $sel = " selected";
else $sel = "";

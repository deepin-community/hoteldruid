...
$titolo = "HotelDruid: Modifica Ospiti";
...
$email2_aux = ${"email2".$id_prenota."_".$num1};
$email_cert_aux = ${"email_cert".$id_prenota."_".$num1};
...
$regione_def = addslashes(fixset($regione_def));
...
$citta_def = addslashes(fixset($citta_def));
